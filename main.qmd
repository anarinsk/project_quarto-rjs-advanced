...
<div style="width: 23vw; height: 4vw; background-color: none; border: 2mm ridge rgba(211, 220, 50, .6); opacity:0.8; transform: translate(0%, 0%);">
</div>
:::
...
```md
:::{style="margin-top:-62px; margin-left: 380px;"}
<div style="width: 23vw; height: 4vw; 
