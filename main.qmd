...
format: 
    revealjs:
        ...
        #self-contained: true
        slide-number: c/t
        theme: [format.scss, customs.scss, theme-dark.scss]
...
- width와 height를 키울수록 슬라이드의 기본 사이즈는 작아진다. 
...
## `callout` 1: Font Size {.smaller}

::: {.callout-warning icon="true" style="font-size: 90%;"}
...
- `::: {.callout-warning icon="false" style="font-size: 80%;"}`를 활용하도록 하자. 

## `callout` 2: Customization {.smaller}
...
<div style="width: 11.2em; height: 2em; background-color: none; border: 0.3em ridge rgba(211, 220, 50, .6); 
...
- 다만 페이지 안에 그냥 해당 태그를 달 경우 위치가 고정되지 않는다. 
...
```md
:::{style="margin-top:-62px; margin-left: 380px;"}
<div style="width: 11.2em; height: 2em; background-color: none; border: 0.3em ridge rgba(211, 220, 50, .6); opacity:0.8; transform: translate(0%, 0%);">
</div>
:::
```
